...
<body>
    ...
    <form action="ban-add.php" method="POST">
        ...
        <input type="submit" value="Add Us">
    </form>
...
<body>
    <div class="div-all">
        ...
        <main>
            ...
            <form action="/duantotnghiep/Cofee_API/tableBan/ban-add.php" method="POST">
            <section class="thongtinMK">
                <label for="">Tâng:<input type="text" name="id_tang" ></label> <br>
                <label for="">Tên bàn:<input type="text" name="soBan" placeholder="Nhập tên bàn"></label> <br>
                <label for="">Trạng thái:<input type="text" name="trangThai" placeholder="Trạng thái bàn"></label> <br>
                <div class="oclock">
                ...
                <a href="http://127.0.0.1:5500/duantotnghiep/man_chinh/Quan_ly_ban.html" type="submit">Thêm Bàn</a>
            </section>
        </form>
        </main>
    </div>
