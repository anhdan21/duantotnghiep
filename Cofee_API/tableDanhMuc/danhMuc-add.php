...
<body>
    <div class="div-all">
        ...
        <main>
            ...
            <form action="/duantotnghiep/Cofee_API/tableDanhMuc/danhMuc-add.php" method="POST">
            <section class="thongtinMK">
                <label for="">Tên loại:<input type="text" name="ten_danhMuc" placeholder="Nhập tên loại"></label> <br>
                ...
                <a href="http://127.0.0.1:5500/duantotnghiep/man_chinh/Do_ban_chay.html" type="submit">Thêm Danh Sách</a>
            </section>
        </form>
        </main>
    </div>
