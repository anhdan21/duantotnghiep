...
<body>
    <div class="div-all">
        ...
        <main>
            ...
            <form action="/duantotnghiep/Cofee_API/tableGiam/sale-add.php" method="POST">
            <section class="thongtinMK">
                <label for="">Time Start:<input type="date" name="time_Start"></label> <br>
                <label for="">Time End:<input type="date" name="time_End"></label> <br>
                <label for="">Giảm:<input type="text" name="giam" placeholder="Phần trăm giảm"></label> <br>
                <div class="oclock">
                ...
                <a href="http://127.0.0.1:5500/duantotnghiep/man_chinh/Khuyen_mai.html" type="Thêm Giảm Giá"></a>
