    ...
    <div class="div-all">
        ...
        <main>
            ...
            <section class="thongtinMK">
                <label for="">Tên NL:<input type="text" name="ten_nguyenLieu" placeholder="Nhập tên Nguyên Liệu"></label> <br>
                <label for="">Giá :<input type="text" name="price" placeholder="Nhập giá "></label> <br>
                <label for="">Số lượng:<input type="number" name="soLuong" ></label> <br>
                <label for="">User:<input type="text" name="id_User" ></label> <br>
