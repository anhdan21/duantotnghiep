...
try {
    ...
    $stmt = $conn->prepare("SELECT sanpham.*, danhmuc.ten_danhMuc AS ten_danhmuc ,giamgia.giam AS Giam
    FROM sanpham
    ...
    echo "<table border='1'>
            <tr> <th>Danh Mục</th> <th>Tên sản phẩm</th> <th>Ảnh sản phẩm</th>  <th>Giá</th> <th style='width:40%'>Giới thiệu</th>  <th>Kích cỡ</th> <th>Giảm giá </th> <th style='width:100px'>Thao tác</th> </tr> ";
