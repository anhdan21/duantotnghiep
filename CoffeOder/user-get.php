                    ...
                    <td><?php echo $r['fullName']; ?></td>
                           <td ><img src="<?php echo $r['image']; ?>" alt="Loading" style="width: 100px;height: 100px;"> </td>
                            ...
                            <td> <div  class="sua" >
                                ...
                                <a   style="margin-right: 18px;" href="user-edit.php?id=<?php echo $r['Id_User'];?>">Sửa</a>
                                <!-- <dialog id="myDialog">
                            ...
                            <button type="submit" type="margin-top :2% " onclick="ex()"> X</button>
                                ...
                                <a onclick="myFunction()" href="user-set.php?id=<?php echo $r['Id_User'];?>" >Chi tiết</a>
                                <dialog id="myDialog">
                                    
                                        <form action="" method="POST">
                                            <label><input type="hidden" value="user-set.php?sid=<?php echo$r['Id_User']?>" name="sid" ></label><br>
                                            <label name="fullName">Name: <?php echo$r['fullName']?></label><br>
                                            <label name="image">Image: <img src="<?php echo$r['image']?>" alt=""></label><br>
                                            <label name="phone_Number">SĐT: <?php echo$r['phone_Number']?></label><br>
                                            <label name="chucNang">Vị Trí: <?php echo$r['chucNang']?></label><br>
                                        </form>
                                        <button type="submit" type="margin-top :2% " onclick="ex()"> X</button>
                                </dialog>
                            </div> </td>
